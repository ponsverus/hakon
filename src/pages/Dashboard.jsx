                      ...
                      {formInfo.galeria.map((url) => (
                        <div key={url} className="relative bg-dark-100 border border-gray-800 rounded-custom overflow-hidden">
                          ...
                          <button
                            ...
                            className="absolute top-2 right-2 px-2 py-1 rounded-full bg-black/60 border border-gray-700 hover:border-red-400 text-[8px] text-red-200 font-normal uppercase"
                            title="Remover"
                          >
                            REMOVER
                          </button>
